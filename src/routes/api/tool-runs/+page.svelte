<script lang="ts">
    ...
    // Initialize filters from URL/data
    let hostname = $state(data.initialFilters?.hostname || '')
    let companyCode = $state(data.initialFilters?.companyCode || '')
    let appName = $state(data.initialFilters?.appName || '')
    let level = $state(data.initialFilters?.level || '')
    let textSearch = $state(data.initialFilters?.textSearch || '')
    let toolNameFilter = $state(data.initialFilters?.toolName || '')
    let statusFilter = $state(data.initialFilters?.status || '')
    let versionFilter = $state(data.initialFilters?.version || '')
    ...
    let offset = $state(data.initialFilters?.offset || 0)
    let limit = $state(data.initialFilters?.limit || 50)
